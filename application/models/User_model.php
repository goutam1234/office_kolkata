<?php
    ...
    public function check_exist_employee($email){
        $query = $this->db->query("call checkavailablity_proc('$email')");
        return $query->num_rows();
    }

    // public function AddEmplyee($data) {
    //     $insert_data = $this->db->insert( 'employee_login', $data );
    //     return $insert_data;
    // }
