(function() {
  ...
  function takepicture() {
    ...
    if (width && height) {
      ...
      $.ajax({
        url:base_url+"admin/payin/save_lifetime_total_image",
        ...
        success:function(data){
          ...
          if(data.status){
            ...
            $("#life_time_total_image").val(data.image_link);
            $("#life_time_total_image_a").attr('href', base_url +'public/upload_image/temp_payin_images/'+data.image_link);
            $("#life_time_total_image_img").attr('src', base_url +'public/upload_image/temp_payin_images/'+data.image_link);
            $(".contentarea2").hide();
